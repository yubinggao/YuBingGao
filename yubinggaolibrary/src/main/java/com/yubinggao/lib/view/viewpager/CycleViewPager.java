package com.yubinggao.lib.view.viewpager;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    public void setData(List<ImageView> views, List<ViewPagerInfo> list, ImageCycleViewListener listener) {
     ...
     */
    public void setData(List<ImageView> views, List<ViewPagerInfo> list, ImageCycleViewListener listener, int showPosition) {
    ...
    private void start() {
        handler.removeMessages(WHEEL);
        handler.sendEmptyMessageDelayed(WHEEL, time);
    }
    ...
    /**
     * 设置轮播间隔时间，即没多少秒切换到下一张视图.默认5000ms
     *
     * @param time 毫秒为单位
     */
     ...
     * @author Yuedong Li
     */
    private class ViewPagerAdapter extends PagerAdapter implements View.OnTouchListener {
